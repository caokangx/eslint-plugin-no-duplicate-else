...
ruleTester.run('no-dupe-else-if', rule, {
  ...
  invalid: [
    ...
    // various kinds of test conditions
    {
      ...
      errors: [
        { messageId: 'unexpected', type: 'BinaryExpression', column: 26 },
      ],
    },
    {
      code: 'if (1 < a) {} else if (1 < a) {}',
      errors: [
        { messageId: 'unexpected', type: 'BinaryExpression', column: 24 },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 25 },
      ],
    },
    {
      code: 'if (a && b || c)  {} else if (a && b || c) {}',
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 31 },
      ],
    },
    {
    ...
    // extra parens around the whole test condition do not affect comparison
    {
      code: 'if (a === 1) {} else if ((a === 1)) {}',
      errors: [
        { messageId: 'unexpected', type: 'BinaryExpression', column: 27 },
      ],
    },
    ...
    },
    {
      ...
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 35 },
      ],
    },
    {
      code: 'if (a || b) {} else if (c || d) {} else if (a || d) {}',
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 45 },
      ],
    },
    {
      code: 'if ((a === b && fn(c)) || d) {} else if (fn(c) && a === b) {}',
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 42 },
      ],
    },
    {
      code: 'if (a) {} else if (a && b) {}',
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 20 },
      ],
    },
    {
      code: 'if (a && b) {} else if (b && a) {}',
    ...
    },
    {
      ...
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 40 },
      ],
    },
    {
      code: 'if (a || b && c) {} else if (b && c && d) {}',
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 30 },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 39 },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 55 },
      ],
    },
    {
    ...
    },
    {
      code: 'if (a || (b || c)) {} else if (a || (b && c)) {}',
      errors: [
        { messageId: 'unexpected', type: 'LogicalExpression', column: 32 },
      ],
    },
    {
      code:
